...
class GoogleMapSearchModelLatAndLong {
  List<AddressResult>? results;
  String? status;

  GoogleMapSearchModelLatAndLong({this.results, this.status});

  factory GoogleMapSearchModelLatAndLong.fromJson(Map<String, dynamic> json) {
    return GoogleMapSearchModelLatAndLong(
      results: json['results'] != null
          ? (json['results'] as List)
              .map((i) => AddressResult.fromJson(i))
              .toList()
          : null,
      status: json['status'],
    );
...
class AddressResult {
  ...
  AddressResult({this.formattedAddress});
